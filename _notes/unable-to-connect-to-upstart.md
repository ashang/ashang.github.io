...
Upstart jobs cannot be started in a chroot because upstart acts as a service supervisor, and processes within the chroot are unable to communicate with the upstart running outside of the chroot ([430224](https://bugs.launchpad.net/bugs/430224)).
...
Users are advised to configure their chroots with /sbin/initctl pointing to /bin/true
