...
之后GOPATH、GOROOT等环境变量会自动设置好，这样就可以直接使用了。


```
bash < <(curl -s -S -L https://raw.githubusercontent.com/moovweb/gvm/master/binscripts/gvm-installer)

Cloning from https://github.com/moovweb/gvm.git to /home/aaron/.gvm
Created profile for existing install of Go at /home/aaron/go
Installed GVM v1.0.22

Please restart your terminal session or to get started right away run
 `source /home/aaron/.gvm/scripts/gvm`
```
...
GOPATH允许多个目录，默认会将go get的内容放在第一个目录下。
