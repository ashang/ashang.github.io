...
## journald 收集日志并保存为二进制。

/etc/machine-id

/lib/systemd/system/systemd-machine-id-commit.service:ConditionPathIsMountPoint=/etc/machine-id


/var/log/journal


runtime journal files are stored at /run/log/journal/. And these are removed
in each boot.



$ journalctl --disk-usage
Archived and active journals take up 75.1M in the file system.
...
journalctl with vacuum-size, vacuum-time, and vacuum-files switches to force
systemd to clear the logs.
...
The systemd provides many parameters for you to effectively manage the log
files. By combining these parameters you can effectively limit the disk space
used by the journal files. Let’s take a look.
journald.conf parameterDescriptionExample
SystemMaxUseSpecifies the maximum			disk space that can be used by the
journal in persistent storageSystem	MaxUse=500M
SystemKeepFreeSpecifies the amount of space that the journ	al should leave
free when adding journal entries to persistent storage.SystemKeepFree=100M
SystemMaxFileSizeControls how large individual journal files ca		n grow to
in persistent storage before being rotated.SystemMaxFileSize	=100M
RuntimeMaxUseSpecifies the maximum disk space that can be used i	n volatile
storage (within the /run filesystem).RuntimeMaxUse=100M
Run	timeKeepFreeSpecifies the amount of space to be set aside for other us	es
when writing data to volatile storage (within the /run filesystem).
RuntimeMaxUse=100M
RuntimeMaxFileSizeSpecifies the amount of space that an individual jou	rnal
file can take up in volatile storage (within the /run filesystem) before being
rotated.RuntimeMaxFileSize=200M

If you add these values in a running syst	em in /etc/systemd/journald.conf
file, then you have to restart the journald after updating the file. To
...
The unit files are stored in two places ideally in a Linux system. The files
created at run time, boot time are stored in /run/systemd/system/. The unit
files you create manually (e.g. systemctl enable command) is stored at
/etc/systemd/system/.

The /etc/systemd/system/ path takes precedance over the run time unit files
present at /run/systemd/system/.

There is another path where systemd keeps the system’s copy of the service
...
state values which you can use are –
...
#
    ...
    change it to be recorded continuously.
...
For the previous boot, use '-1' instead of '0', or give two previous booting
'-2', etc.
 ...
 To display only the error message from the current boot, enter:
  ...
  If you want to see errors from all booting times, just delete the parameter
  '-b':
...
Filter log entries according to the path to handle executable files or Systemd
unit

Some processes are started and managed by units called systemd. To see all
records related to cron service unit, enter:
...
to use the path to the executable file (binary file) of the program, simply
pass its full path as an argument.

 journalctl /usr/sbin/cron

 Don't forget, you can also filter by the current boot item to remove
...
$ journalctl | head
-- Journal begins at Wed 2021-09-08 11:11:26 CST, ends at Wed 2021-09-15 10:23:20 CST. --
Sep 08 11:11:26 i54 firefox[693057]: Unable to load hand2 from the cursor theme
Sep 08 11:11:26 i54 firefox[693057]: Unable to load hand2 from the cursor theme
Sep 08 11:11:26 i54 firefox[693057]: Unable to load hand2 from the cursor theme
Sep 08 11:11:26 i54 firefox[693057]: Unable to load hand2 from the cursor theme
Sep 08 11:11:26 i54 firefox[693057]: Unable to load hand2 from the cursor theme
...
$ journalctl -o short-iso | head
-- Journal begins at Wed 2021-09-08 11:11:26 CST, ends at Wed 2021-09-15 10:23:20 CST. --
2021-09-08T11:11:26+0800 i54 firefox[693057]: Unable to load hand2 from the cursor theme
2021-09-08T11:11:26+0800 i54 firefox[693057]: Unable to load hand2 from the cursor theme
2021-09-08T11:11:26+0800 i54 firefox[693057]: Unable to load hand2 from the cursor theme
2021-09-08T11:11:26+0800 i54 firefox[693057]: Unable to load hand2 from the cursor theme
2021-09-08T11:11:26+0800 i54 firefox[693057]: Unable to load hand2 from the cursor theme
...
$ journalctl -o short-monotonic | head
-- Journal begins at Wed 2021-09-08 11:11:26 CST, ends at Wed 2021-09-15 10:23:20 CST. --
[1184547.507515] i54 firefox[693057]: Unable to load hand2 from the cursor theme
[1184547.515744] i54 firefox[693057]: Unable to load hand2 from the cursor theme
[1184547.516014] i54 firefox[693057]: Unable to load hand2 from the cursor theme
[1184547.516086] i54 firefox[693057]: Unable to load hand2 from the cursor theme
[1184547.516147] i54 firefox[693057]: Unable to load hand2 from the cursor theme
[1184547.516206] i54 firefox[693057]: Unable to load hand2 from the cursor theme
[1184547.516278] i54 firefox[693057]: Unable to load hand2 from the cursor theme
[1184547.532236] i54 firefox[693057]: Unable to load hand2 from the cursor theme
[1184547.534299] i54 firefox[693057]: Unable to load hand2 from the cursor theme
...
journalctl -xe NM_CONNECTION=1010a025-8289-4d89-9036-9ec9eaa922a2 + NM_DEVICE=wlp6s0




# manage log with journalctl


Edit file:   /etc/systemd/system.conf
...
Then create the '/var/log/journal/' dir, the system will auto store the
log as persistent.
...
and after reboot, you can check the old log with:
...
#
+++ /etc/systemd/journald.conf.dpkg-new 2016-07-28 12:35:26.000000000 +0800
@@ -5,7 +5,11 @@
 #  the Free Software Foundation; either version 2.1 of the License, or
 #  (at your option) any later version.
 #
