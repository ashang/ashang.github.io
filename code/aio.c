...
opened a on descriptor 3
opened b on descriptor 4
opened c on descriptor 5
I/O completion signal received
I/O completion signal received
opened d on descriptor 6
I/O completion signal received
I/O completion signal received
aio_error():
    for request 0 (descriptor 3): I/O succeeded
    for request 1 (descriptor 4): I/O succeeded
    for request 2 (descriptor 5): I/O succeeded
    for request 3 (descriptor 6): I/O succeeded
All I/O requests completed
aio_return():
    for request 0 (descriptor 3): 20
    for request 1 (descriptor 4): 20
    for request 2 (descriptor 5): 20
    for request 3 (descriptor 6): 20
*/
