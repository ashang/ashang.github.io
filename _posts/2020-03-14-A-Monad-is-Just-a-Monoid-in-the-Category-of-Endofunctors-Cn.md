...
monad transformer 运行效率特别低，最终舍弃这些抽象只拿来做 IO 。

做异步抽象啊，比如 js 的 promise.





1.精通PyTorch或Tensorflow框架，熟悉C/C++编程语言；
2.精通常用自然语言处理模型的训练和调优，包括：BERT、RoBERTa、T5等；




3、在机器学习方向有较好的积累，熟练掌握常用的数据挖掘算法并有实践经验，了解分类、聚类、回归等基本场景下的机器学习算法；
4、熟练掌握海量数据处理技术，有使用python 或者 Hadoop/Hive/Spark分析海量数据的能力和经验；
5、能理解用户数据分析和挖掘应用场景，根据需求负责设计数据分析挖掘模型及算法；




5、熟悉C++11新特性，能够在工作中熟练使用
6、熟练掌握STL容器、算法、迭代器；
7、了解xml、json格式数据解析；
8、熟悉tcp、http协议，掌握C++网络编程；



2、具备图像处理及识别的基础理论和算法知识，掌握C/C++程序设计，熟悉VC开发，熟悉MATLAB，熟悉深度学习框架（caffe、pytorch等），有良好的编码习惯；
