---
title: "apt notes"
date: 2021-06-09T19:39:59+08:00
draft: true
---
...
标记为“已安装”状态，但不会真正安装，需要配合 apt-get dselect-upgrade 进行安装。
...
## dpkg --set-selections 主要用于批量管理 Debian/Ubuntu 系统上的软件包安装状态，通常与 dpkg --get-selections 和 apt-get dselect-upgrade 结合使用。


echo "vim deinstall" | sudo dpkg --set-selections
...
# dpkg-query -Wf='${Installed-Size} KB\n' python3.11-minimal
6770 KB
