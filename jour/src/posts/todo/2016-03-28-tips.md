...
Type about:config in the browser's address bar and hit the enter key on your keyboard.

Search for the preference `browser.showQuitWarning`, make it true.

Or you may want to set all of the following to true:
